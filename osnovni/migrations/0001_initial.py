    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vrsta_predmeta', models.CharField(blank=True, max_length=200, null=True, verbose_name='vrsta predmeta')),
                ...
                ('br_protokola', models.CharField(blank=True, max_length=50, null=True, verbose_name='broj delovodnog protokola')),
                ('br_racuna', models.CharField(blank=True, max_length=50, null=True, verbose_name='broj ra\u010duna')),
                ('datum_kreiranja', models.DateField(default=datetime.datetime.now, verbose_name='datum upisa')),
                ('fotografija', models.FileField(blank=True, null=True, upload_to=osnovni.models.get_path_fotografija, verbose_name='fotografija')),
                ('kategorija', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='osnovni.KategorijaPredmeta', verbose_name='kategorija')),
                ('kreirao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgsema.Radnik', verbose_name='kreator zapisa')),
